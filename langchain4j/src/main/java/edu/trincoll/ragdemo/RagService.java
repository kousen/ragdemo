...
/**
 * RAG service using LangChain4j — no Spring Boot required.
 * <p>
...
public class RagService {
     ...
     * The EmbeddingStoreIngestor handles chunking with overlap, embedding,
     * and storage in one call.
     *
     * @param documents documents to ingest
     */
    public void ingest(Document... documents) {
        ingestor.ingest(List.of(documents));
    }
