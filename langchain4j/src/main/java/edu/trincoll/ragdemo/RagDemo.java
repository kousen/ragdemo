...
public class RagDemo {
    ...
    public static void main(String[] args) {
        System.out.println("\n=== RAG Demo (Java/LangChain4j + Supabase) ===\n");
        ...
        String supabasePassword = System.getenv("SUPABASE_PASSWORD");
        if (supabasePassword == null || supabasePassword.isBlank()) {
            System.err.println("Error: SUPABASE_PASSWORD environment variable is not set.");
            System.err.println("Set Supabase credentials with: source .env");
            System.exit(1);
        }
